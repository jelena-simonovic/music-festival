    ...
    <div class="container">
        <div class="row">
            <div class="col-6 mb-5">
                <form class="p-4" action="./checkout-page.php" method="POST" style="border: solid black 2px; border-radius: 2%; text-align:left;">
                    ...
                    <button type="submit" class="btn btn-success mb-1" name="buy" value="yes">Buy</button>
                </form>
            </div>
            <div class="col-6">
